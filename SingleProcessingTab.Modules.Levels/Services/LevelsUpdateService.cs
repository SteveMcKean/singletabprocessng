...
public class LevelsUpdateService: BaseUpdateService<UpdateData,Level>
{
    ...
    // private readonly BehaviorSubject<UpdateData> uiDataSubject = new(new UpdateData( 2, ""));
    //
    //
    ...
    //                     uiDataSubject.OnNext(new UpdateData(2, DateTime.UtcNow.ToLongTimeString()));
    //
